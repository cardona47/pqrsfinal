...
<html>
    ...
    <body>
        <section class="vh-100" style="background: linear-gradient(to bottom, #000000, #8B0000);">
                        ...
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    <img src="Imagenes/Logofinal.png" class="img-fluid rounded-start" alt="Imagen de PQRS" style="height: 100%; object-fit: cover;">
                                </div>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form action="SvIngreso" method="POST">
                                            <div class="d-flex align-items-center mb-3 pb-1">
                                                ...
                                                <span class="h1 fw-bold mb-0">Sistema PQRS Urban Style</span>
                                            </div>
